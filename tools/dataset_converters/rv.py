...
rv_invert_palette = {tuple(v): k for k, v in rv_palette.items()}


def rv_convert_from_color(arr_3d, palette=rv_invert_palette):
...
def process_annotations(src_dir, out_dir):
    ...
    for mode in ['train', 'val']:
        ...
        for img_path in src_path_list:
            ...
            label_idx = rv_convert_from_color(label)
